...
**Create social links for your articles (support for facebook, Twitter ,G+, Pinterest Tumblr, Pocket & Instapaper) with an icon (optional and in SVG format) a share counting (optional) plus all needed Open Graph meta tags for your head document.**
